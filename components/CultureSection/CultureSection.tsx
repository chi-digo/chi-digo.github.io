...
const DISCOVER_CARDS: DiscoverCard[] = [
  {
    ...
    desc: {
      ...
      dg: 'Wapiha muvwi dzulu na kuambira Adigo undaangukira kuphi. Nabii-mpiga mivwi ambaye maono gakye gaunda atu kabila ya akoloni kufika.',
    },
    href: '/history',
  },
  {
    ...
    desc: {
      ...
      dg: 'Kabila ya dzina rako, kabila ya mudzi wako — "Wa atu ani?" Mfumo wa ukoo wa mayo ambao bado unafafanua chila uhusiano wa Chidigo, kula ndoa hadi mundani hadi mazishi.',
    },
  ...
  },
  {
    ...
    eyebrow: {
      ...
      dg: 'Lahaja 4 kula Likoni hadi Tanga',
    },
    title: {
      en: 'Digo Accents',
      sw: 'Lafudhi za Kidigo',
      dg: 'Lafudhi za Chidigo',
    },
    desc: {
      ...
      dg: 'Chinondo, Ungu, Ts\'imba, Tsw\'aka — luga mwenga, lafudhi ne, tsi mbiri. Dze, munenedzi wa Likoni anaweza kumuelewa wa Tanga?',
    },
    href: '/language',
  },
  {
    ...
    eyebrow: {
      ...
      dg: 'Midzi 21 tsi ya Kenya na Tanzania',
    },
    title: {
    ...
    desc: {
      ...
      dg: 'Kula Diani Beach hadi Vanga — mudzi wa mwisho wa Kenya — na kuvuka mpaka hadi Moa, makalo ga akare.',
    },
  ...
  },
  {
    ...
    desc: {
      ...
      dg: 'Chimila peke ya muziki pwani ya Uswahili chiricho cha atu amwenga. Ngoma sita, filimbi ya mwanzi alfajiri.',
    },
  ...
  },
  {
    ...
    desc: {
      ...
      dg: 'Ekari mirongo mihahu za tsaka ra kare kahi ya pwani na kare na kare. Mihi ya miaka zaidi ya 1,000, aina 5 ambazo tazipatikana phatu phanjine duniani.',
    },
    ...
    <section id="culture" className={styles.section}>
      <div className={styles.inner}>
        <p className={styles.eyebrow}>
          {locale === 'sw' ? 'Gundua' : locale === 'dg' ? 'Gundua' : 'Discover'}
        </p>
