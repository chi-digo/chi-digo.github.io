        ...
        <div className={styles.content}>
            ...
            <SearchCombobox
              ...
              placeholder={
                locale === 'sw' ? 'Tafuta maneno, methali, makala…'
                  : locale === 'dg' ? 'Tafuta maneno, ndarira, makala…'
          ...
          <div className={styles.pills}>
            {QUICK_LINKS.map((link) => (
              ...
              >
                {locale === 'sw' ? link.labelSw : locale === 'dg' ? link.labelDig : link.label}
              </TrackedLink>
            ))}
          </div>
      ...
      <section ref={exploreRef} className={styles.exploreSection}>
        <div className={styles.sectionInner}>
          <p className={styles.eyebrow}>
            {locale === 'sw' ? 'Chunguza' : locale === 'dg' ? 'Chunguza' : 'Explore'}
          </p>
          ...
          <div className={styles.exploreGrid}>
            ...
            >
              <span className={styles.featureBadge}>
                {locale === 'sw' ? 'Neno la Leo' : locale === 'dg' ? 'Neno ra Rero' : 'Word of the Day'}
              </span>
              {wotdEntry ? (
                <>
            ...
            <TrackedLink href="/history" source="explore_grid" className={styles.featureCard}>
              <span className={styles.featureStat}>
                {locale === 'sw' ? 'Kutoka Singwaya hadi leo' : locale === 'dg' ? 'Kula Singwaya hadi rero' : 'From Singwaya to today'}
              </span>
              <span className={styles.featureTitle}>
                {locale === 'sw' ? 'Historia' : locale === 'dg' ? 'Historia' : 'History'}
              </span>
              <span className={styles.featureDesc}>
                {locale === 'sw'
