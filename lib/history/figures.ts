...
export const figures: Figure[] = [
  {
    ...
    role: {
      ...
      dg: 'Mtawala-mtabiri, mganga, mpiga mishale',
    },
    ...
    summary: {
      ...
      dg: 'Chiongozi wa kabla ya ukoloni ambaye mamlaka gakpwe garitokana na uganga, utabiri, na ushauri. Aongozi a makabila ga jirani — Asambaa, Asegeju, na anjine — amtafuta kpwa utabiri wa matatizo magumu.',
    },
  },
  {
    ...
    summary: {
      ...
      dg: 'Waongozwa ni ndoso, achigundua msikiti wa mawe ga matumbawe wa karne ya 13 uriozikwa tsini ya misitu ya karne nyinji kuko Diani. Urejesho wakpwe wa Msikiti wa Kongo waanzisha mojawapo ya maeneo muhimu zaidi ya urithi wa Chiislamu Afrika ya Mashariki.',
    },
  },
  {
    ...
    summary: {
      ...
      dg: 'Mzehe mkulu wa Diani ariyekala mwongofu wa kpwandza wa Chiislamu kahi za Adigo — mutu muhimu kahi za Uislamu ambao ungeahenda Adigo kukala kundi ra pekee ra Aislamu anji kahi za makabila tisiya ga Amijikenda.',
    },
  },
  {
    ...
    role: {
      ...
      dg: 'Mwanahistoria na mtaalamu wa makabila',
    },
    region: 'Tanga, Tanzania',
    summary: {
      ...
      dg: 'Mwandishi wa Asili ya Tanga phamwenga na asili ya Adigo, Asegeju na Adaiso — jaribio ra chimfumo ra kurekodi asili ya atu a Tanga kabla ya chizazi cha mwisho cha anahistoria a mdomo kupita.',
    },
  },
  {
    ...
    role: {
      ...
      dg: 'Mtaalamu wa masomo ga Chiislamu, Katibu wa Ngambi ya Adigo',
    },
    region: 'Kilifi, Kenya',
    summary: {
      ...
      dg: 'Profesa Mshiriki kpwa Chuo Chikulu cha Pwani ambaye utafiti wakpwe kuhusu mahakama za makadhi, utawala wa chikoloni, na utambulisho wa Chiislamu pwani ya Kenya umechapishwa ni Cambridge, Edinburgh, na Brill. Piya ni Katibu wa Ngambi ya Adigo.',
    },
  },
  {
    ...
    role: {
      ...
      dg: 'Mwanaisimu, isimu ya kompyuta ya Chiswahili/Chibantu',
    },
    ...
    summary: {
      ...
      dg: 'Profesa Mshiriki wa Kufundisha kpwa UNC Chapel Hill anayedzenga vyombo vya kompyuta kpwa uhifadhi wa luga za Chibantu. Kazi yakpwe kuhusu NLP ya Chiswahili na uchambuzi wa hisia inadzenga miundombinu inayofaidisha luga ndogo za Chibantu dza Chidigo.',
    },
  },
];
