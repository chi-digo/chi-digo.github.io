...
export const dialects: Dialect[] = [
  {
    ...
    description: {
      ...
      dg: 'Lahaja ya heshima na msingi wa chiandiko cha kawaida. Machapisho gosi ga Chidigo — Kamusi ya Mgombato, Biblia ya Chidigo, na vyombo vya BTL — vinategemea Chinondo.',
    },
    area: 'Likoni – Msambweni',
    speakers: {
      en: 'Majority of Kenyan Digo speakers',
      sw: 'Wengi wa wazungumzaji wa Kidigo Kenya',
      dg: 'Anji a azungumzadzi a Chidigo Kenya',
    },
    color: '#2D3778',
  },
  {
    ...
    description: {
      ...
      dg: 'Inazungumzwa kusi kwa Msambweni kupishira miphaka ya Kenya-Tanzania hadi wilaya za Tanga na Muheza. Ushawishi mkulu wa Chiswahili kula mawasiliano na lahaja za Chiswahili cha Tanga.',
    },
    area: 'Msambweni – Tanga',
    speakers: {
      en: '~166,000 Tanzania-side Digo',
      sw: 'Wadigo ~166,000 upande wa Tanzania',
      dg: 'Adigo ~166,000 uphande wa Tanzania',
    },
    color: '#8B6914',
  },
  {
    ...
    description: {
      ...
      dg: 'Inazungumzwa kpwa Shimba Hills, nyanda za dzulu za msitu wa bara. Kutengwa kwa jiografia kumehifadhi maneno ga Chidigo ga zamani na kuendeleza sifa za chiphekee.',
    },
    area: 'Vuga – Ng\'onzini',
    speakers: {
      en: 'Shimba Hills communities',
      sw: 'Jamii za Shimba Hills',
      dg: 'Jamii za Shimba Hills',
    },
    color: '#2E7D32',
  },
  {
    ...
    description: {
      ...
      dg: 'Aina ya Chidigo yenye tofauti kulu zaidi ya luga, inayozungumzwa kanda-kanda ya Rasi ya Shimoni phephi na miphaka ya Tanzania. Ushawishi mkulu wa Chiswahili cha Vumba unatengeneza aina ya mphito.',
    },
    area: 'Shimoni Peninsula',
    speakers: {
      en: 'Smallest dialect community',
      sw: 'Jamii ndogo zaidi ya lahaja',
      dg: 'Jamii ndogo zaidi ya lahaja',
    },
    color: '#C62828',
  },
];
