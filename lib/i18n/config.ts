...
export interface Messages {
  ...
  kanga: {
    ...
    step_style: string;
    step_preview: string;
    choose_message_title: string;
    choose_message_description: string;
    browse_proverbs: string;
    type_your_own: string;
    search_proverbs: string;
    ...
    color_scheme: string;
    border_motif: string;
    center_layout: string;
    center_motif: string;
    comp_grid_repeat: string;
    comp_central_medallion: string;
    comp_scattered: string;
    comp_horizontal_bands: string;
    comp_solid: string;
    motif_diamond_chain: string;
    motif_mikeka: string;
    motif_door_frame: string;
    motif_medallion: string;
    motif_korosho: string;
    motif_knots: string;
    pattern_sunburst: string;
