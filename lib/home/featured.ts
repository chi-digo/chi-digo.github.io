  ...
  [
    {
      ...
      domain: 'kayas',
      slug: 'what-is-a-kaya',
      title: { en: 'What is a Kaya?', sw: 'Kaya ni Nini?', dg: 'Kaya ni Chitu Gani?' },
      intro: {
        ...
        dg: 'Makaya ni makalo ga misitu genye ngome garigokala vituo vya chiroho na chisiasa vya maisha ga Amijikenda kpwa karne nyinji.',
      },
  ...
  [
    {
      section: 'history',
      slug: 'singwaya',
      title: { en: 'The Singwaya Migration', sw: 'Uhamiaji wa Singwaya', dg: 'Uhamiaji wa Singwaya' },
      intro: {
        ...
        dg: 'Hadisi ya vira Adigo na atu anjine a Amijikenda arivyosafiri kula Singwaya hadi ph\'wani ya Kenya.',
      },
  ...
  [
    {
      ...
      title: { en: 'Folk Tales and Stories', sw: 'Hadisi za Chinyume', dg: 'Hadithi za Jadi' },
      intro: {
        ...
        dg: 'Kpwa vidzi vya Kaunti ya Kwale, kuna wakati wa siku ambao ni wa hadisi — zinazosimulirwa usiku bahi.',
      },
  ...
  [
    {
      ...
      domain: 'music',
      slug: 'chakacha',
      title: { en: 'Chakacha Dance', sw: 'Ngoma ya Chakacha', dg: 'Ngoma ya Chakacha' },
      intro: {
        ...
        dg: 'Chakacha ni ngoma ya chipekee ya sherehe za Adigo — utendaji wa viuno unaokpwedza kula harusini hadi tamashe.',
      },
