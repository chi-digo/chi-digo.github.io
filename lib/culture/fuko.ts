...
export const fukoCards: FukoCard[] = [
  {
    ...
    description: {
      ...
      dg: 'Uanachama wa ukoo unapishira mayo bahi. "Wa atu ani?" — ndiro swali rinaro mtambulisha Mudigo, na jibu rinarejelea fuko.',
    },
  },
  {
    slug: 'mjomba',
    ...
    description: {
      ...
      dg: 'Nafasi yenye nguvu zaidi kpwa mfumo wa jadi wa ukoo. Mjomba anawajibika kpwa malezi ga ana, analipa harusi, na mali yakwe inapishira ana a dada yakwe.',
    },
  },
  {
    slug: 'konho',
    ...
    description: {
      ...
      dg: 'Achetu kala ana "udhibiti kamili na uhuru" dzulu ya tsi ya konho, iriyopishirishwa ana ao kupishira mayo. Hiri rikaaphera achetu a Chidigo uhuru mkulu wa chiuchumi.',
    },
  },
  {
    slug: 'chifudu',
    ...
    description: {
      ...
      dg: 'Chila ukoo wa mayo urikadumisha chifudu chakwe — chama cha achetu na ibada ya uzazi. Achetu arikahudumu dza "alezi a nguvu za uzazi za akuku ao a chichetu."',
    },
  },
  {
    slug: 'mwerya',
    ...
    subtitle: {
      ...
      dg: 'Vikundi vya Kazi ya Ushirikiano',
    },
    description: {
      ...
      dg: 'Vikundi vya kazi ya ushirikiano virivyopangwa kulingana na ukoo wa mayo, vinavyoundwa ni achetu a ukoo mmwenga. Mdundo wa kazi ya phamwenga urikaongozwa ni nyimbo za phamwenga.',
    },
  },
  {
    slug: 'fuko-exogamy',
    ...
    description: {
      ...
      dg: 'Bibi na bwana harusi ni lazima atuluke kpwa mafuko tofauti. Wakati wa kuposa, mbari zinachunguza uphatifu wa ukoo. Idhini ya mjomba kpwa ndoa ya mwana muche wa dada yakwe inahitajika.',
    },
  },
  {
    ...
    subtitle: {
      ...
      dg: 'Mifumo Miiri Inayoishi Phamwenga',
    },
    description: {
      ...
      dg: 'Uislamu urikareha urithi wa baba urioupingana na mfumo wa fuko. Matokeo tagakala ushindi safi kpwa uphande wowose ela "maelewano ganagotofautiana kula mbari hadi mbari, mudzi hadi mudzi."',
    },
  },
];
